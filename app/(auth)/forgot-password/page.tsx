    ...
    <>
      <div className="text-center mb-6">
        ...
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
          Recover access to your LOOP workspace.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-blue-100 bg-blue-50/20 p-5 text-sm text-slate-700 dark:border-blue-950/20 dark:bg-blue-950/5 dark:text-slate-300 space-y-3">
        <div className="flex items-center gap-2 text-blue-700 dark:text-blue-400 font-semibold">
          ...
          <span>Enterprise Account Management</span>
        </div>
        <p className="leading-relaxed">
          For security and multi-tenant isolation, automated email recovery is disabled by default in this workspace.
        </p>
        <p className="leading-relaxed">
          Please contact your workspace **Administrator** to reset your credentials. If you are developing locally, you can seed/create new user profiles directly.
        </p>
      </div>
