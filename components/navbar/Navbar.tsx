    ...
    <header className="w-full px-4 sm:px-6 md:px-10 lg:px-12 pt-6 shrink-0 bg-transparent z-40">
      <div className="flex h-20 items-center justify-between px-6 rounded-[20px] border border-slate-200 bg-white/80 dark:border-white/[0.08] dark:bg-[#0f172a]/70 backdrop-blur-xl shadow-sm transition-all duration-300">
        ...
        <div className="hidden md:flex items-center w-full max-w-[500px] mx-6">
          <div className="flex items-center w-full gap-2.5 px-4 py-2.5 rounded-full border border-slate-200 bg-slate-50 text-slate-400 text-xs hover:border-slate-300 dark:border-white/[0.08] dark:bg-white/[0.02] dark:text-[#94A3B8] dark:hover:border-white/[0.15] dark:hover:bg-white/[0.04] transition-all cursor-pointer">
            <Search className="w-3.5 h-3.5 text-slate-400 dark:text-[#94A3B8]" />
            <span className="flex-1 text-left text-xs font-medium">Search feedback, themes, reports...</span>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <button className="flex items-center justify-center w-9 h-9 rounded-xl border border-slate-200 bg-slate-50 hover:bg-slate-100 text-slate-500 hover:text-slate-800 dark:border-white/[0.08] dark:bg-white/[0.02] dark:hover:bg-white/[0.06] dark:text-[#94A3B8] dark:hover:text-white transition-all cursor-pointer">
